...
# debugging
# [{'Namespace': 'AWS/Logs', 'MetricName': 'IncomingLogEvents', 'Dimensions': [{'Name': 'LogGroupName', 'Value': '/aws/lambda/Autoscale-Notifications-To-Slack'}]}, {'Namespace': 'AWS/Logs', 'MetricName'
# : 'IncomingLogEvents', 'Dimensions': [{'Name': 'LogGroupName', 'Value': '/aws/lambda/Cloudwatch-Monitoring-To-Slack'}]}, {'Namespace': 'AWS/Logs', 'MetricName': 'IncomingLogEvents', 'Dimensions': [{'N
# ame': 'LogGroupName', 'Value': '/aws/lambda/Stage-Populate-Cloudfront-IP-Ranges-Into-SG-Port-80'}]}, {'Namespace': 'AWS/Logs', 'MetricName': 'IncomingLogEvents', 'Dimensions': [{'Name': 'LogGroupName'
# , 'Value': '/aws/lambda/Config-Change-Notifications-To-Slack'}]}, {'Namespace': 'AWS/Logs', 'MetricName': 'IncomingLogEvents', 'Dimensions': [{'Name': 'LogGroupName', 'Value': '/aws/lambda/Production-
# Populate-Cloudfront-IP-Ranges-Into-SG-Port-Custom'}]}, {'Namespace': 'AWS/Logs', 'MetricName': 'IncomingLogEvents', 'Dimensions': [{'Name': 'LogGroupName', 'Value': '/aws/lambda/Production-Populate-Cl
# oudfront-IP-Ranges-Into-SG-Port-80'}]}, {'Namespace': 'AWS/Logs', 'MetricName': 'IncomingLogEvents', 'Dimensions': [{'Name': 'LogGroupName', 'Value': '/aws/lambda/Stage-Populate-Cloudfront-IP-Ranges-I
# nto-SG-Port-Custom'}]}, {'Namespace': 'AWS/Logs', 'MetricName': 'IncomingLogEvents', 'Dimensions': [{'Name': 'LogGroupName', 'Value': '/aws/lambda/Production-Populate-Cloudfront-IP-Ranges-Into-SG-Port
# -443'}]}, {'Namespace': 'AWS/Logs', 'MetricName': 'IncomingLogEvents', 'Dimensions': [{'Name': 'LogGroupName', 'Value': '/aws/lambda/Stage-Populate-Cloudfront-IP-Ranges-Into-SG-Port-443'}]}]
...
with PdfPages('AWS_EC2_CPU_Report.pdf') as pdf:
    ...
    d['Author'] = u'James Sawyer'
    d['Subject'] = 'EC2 CPU Monitoring Report'
    d['Keywords'] = 'EC2 CPU Monitoring Report'
